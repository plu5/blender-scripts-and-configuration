...
kmi = km.keymap_items.new('wm.console_toggle', 'F2', 'PRESS', alt=True)
...
kmi = km.keymap_items.new('screen.redo_last', 'BACK_SLASH', 'PRESS', shift=True)
...
kmi = km.keymap_items.new('wm.layout_search', 'F1', 'PRESS', alt=True)
...
kmi_props_setattr(kmi.properties, 'delta', -1)
kmi = km.keymap_items.new('screen.frame_offset', 'PERIOD', 'PRESS', alt=True)
kmi_props_setattr(kmi.properties, 'delta', 1)
kmi = km.keymap_items.new('screen.frame_offset', 'COMMA', 'PRESS', alt=True)
kmi_props_setattr(kmi.properties, 'delta', -1)
...
kmi = km.keymap_items.new('screen.frame_offset', 'WHEELUPMOUSE', 'PRESS', key_modifier='BACK_SLASH')
kmi_props_setattr(kmi.properties, 'delta', 10)
kmi = km.keymap_items.new('screen.frame_offset', 'WHEELDOWNMOUSE', 'PRESS', key_modifier='BACK_SLASH')
kmi_props_setattr(kmi.properties, 'delta', -10)
...
kmi = km.keymap_items.new('anim.keyframe_delete_v3d', 'S', 'PRESS', alt=True)
kmi = km.keymap_items.new('object.parent_to_empty', 'BUTTON4MOUSE', 'PRESS', key_modifier='G')
...
kmi_props_setattr(kmi.properties, 'toggle', False)
kmi_props_setattr(kmi.properties, 'ring', False)
kmi = km.keymap_items.new('mesh.loop_select', 'SELECTMOUSE', 'DOUBLE_CLICK', ctrl=True)
kmi_props_setattr(kmi.properties, 'extend', False)
kmi_props_setattr(kmi.properties, 'deselect', True)
kmi_props_setattr(kmi.properties, 'toggle', False)
kmi_props_setattr(kmi.properties, 'ring', False)
kmi = km.keymap_items.new('mesh.edgering_select', 'SELECTMOUSE', 'DOUBLE_CLICK', alt=True)
kmi_props_setattr(kmi.properties, 'extend', False)
kmi_props_setattr(kmi.properties, 'deselect', False)
kmi_props_setattr(kmi.properties, 'toggle', False)
kmi = km.keymap_items.new('mesh.edgering_select', 'SELECTMOUSE', 'DOUBLE_CLICK', shift=True, alt=True)
kmi_props_setattr(kmi.properties, 'extend', False)
kmi_props_setattr(kmi.properties, 'deselect', False)
kmi_props_setattr(kmi.properties, 'toggle', True)
kmi = km.keymap_items.new('mesh.edgering_select', 'SELECTMOUSE', 'DOUBLE_CLICK', ctrl=True, alt=True)
kmi_props_setattr(kmi.properties, 'extend', False)
kmi_props_setattr(kmi.properties, 'deselect', True)
kmi_props_setattr(kmi.properties, 'toggle', False)
kmi = km.keymap_items.new('mesh.shortest_path_pick', 'MIDDLEMOUSE', 'DOUBLE_CLICK', alt=True)
kmi_props_setattr(kmi.properties, 'use_fill', False)
kmi = km.keymap_items.new('mesh.shortest_path_pick', 'MIDDLEMOUSE', 'DOUBLE_CLICK', shift=True, alt=True)
...
kmi_props_setattr(kmi.properties, 'name', 'edit.mesh_select_mode')
...
kmi = km.keymap_items.new('wm.call_menu', 'X', 'PRESS', shift=True, ctrl=True)
...
kmi = km.keymap_items.new('object.subdivision_set', 'THREE', 'PRESS')
kmi_props_setattr(kmi.properties, 'level', 2)
kmi = km.keymap_items.new('mesh.separate', 'P', 'PRESS', alt=True)
kmi = km.keymap_items.new('transform.edge_crease', 'E', 'PRESS', ctrl=True, alt=True)
kmi = km.keymap_items.new('object.vertex_group_select', 'V', 'PRESS', shift=True, ctrl=True, alt=True)
...
kmi_props_setattr(kmi.properties, 'name', 'VIEW3D_PIE_snap')  # snapping pie menu
kmi = km.keymap_items.new('wm.call_menu_pie', 'INSERT', 'PRESS')
kmi_props_setattr(kmi.properties, 'name', 'view3d.pivot_of')
kmi = km.keymap_items.new('wm.call_menu_pie', 'D', 'PRESS')
kmi_props_setattr(kmi.properties, 'name', 'view3d.pivot_of')
kmi = km.keymap_items.new('wm.call_menu_pie', 'ACCENT_GRAVE', 'PRESS', alt=True)
kmi_props_setattr(kmi.properties, 'name', 'pie.view_of')  # views pie menu
kmi = km.keymap_items.new('wm.call_menu_pie', 'ACCENT_GRAVE', 'PRESS')
kmi_props_setattr(kmi.properties, 'name', 'pie.object_mode_of')
kmi = km.keymap_items.new('wm.call_menu_pie', 'RIGHTMOUSE', 'PRESS')
kmi_props_setattr(kmi.properties, 'name', 'pie.object_mode_of')  # object modes pie menu
...
kmi = km.keymap_items.new('wm.context_toggle_enum', 'SEVEN', 'PRESS')
kmi_props_setattr(kmi.properties, 'data_path', 'space_data.viewport_shade')
kmi_props_setattr(kmi.properties, 'value_1', 'RENDERED')
kmi_props_setattr(kmi.properties, 'value_2', 'RENDERED')
kmi = km.keymap_items.new('object.toggle_wire', 'FOUR', 'PRESS', alt=True)
kmi = km.keymap_items.new('wm.context_toggle', 'FIVE', 'PRESS', alt=True)
kmi_props_setattr(kmi.properties, 'data_path', 'space_data.show_backface_culling')
...
kmi = km.keymap_items.new('transform.translate', 'W', 'PRESS', shift=True, ctrl=True)
kmi = km.keymap_items.new('transform.rotate', 'E', 'PRESS', shift=True, ctrl=True)
kmi = km.keymap_items.new('transform.resize', 'R', 'PRESS', shift=True, ctrl=True)
kmi = km.keymap_items.new('transform.translate', 'MIDDLEMOUSE', 'PRESS') # not sure about this one because then lassoo selection only works when nothing is selected
kmi = km.keymap_items.new('transform.translate', 'MIDDLEMOUSE', 'PRESS', key_modifier='W')
kmi = km.keymap_items.new('transform.rotate', 'MIDDLEMOUSE', 'PRESS', key_modifier='E')
kmi = km.keymap_items.new('transform.resize', 'MIDDLEMOUSE', 'PRESS', key_modifier='R')
kmi = km.keymap_items.new('wm.context_toggle', 'BUTTON4MOUSE', 'PRESS')
...
# kmi = km.keymap_items.new('wm.context_set_enum', 'PERIOD', 'PRESS') # figure out what this is
...
kmi = km.keymap_items.new('text.run_script', 'P', 'PRESS', alt=True) # have a thing where it feeds the name of the script into the console: exec(complie(bpy.data.texts['nameoffile.py'].as_string(), 'nameoffile.py', 'exec'))
...
kmi = km.keymap_items.new('text.copy', 'W', 'PRESS', alt=True)
...
kmi = km.keymap_items.new('text.select_all', 'H', 'PRESS', ctrl=True) #
#kmi = km.keymap_items.new('text.select_line', 'A', 'PRESS', shift=True, ctrl=True)
kmi = km.keymap_items.new('text.select_line', 'L', 'PRESS', shift=True, ctrl=True) #
...
kmi = km.keymap_items.new('text.comment', 'SEMI_COLON', 'PRESS', alt=True)
kmi = km.keymap_items.new('text.uncomment', 'SEMI_COLON', 'PRESS', shift=True, alt=True)
...
kmi = km.keymap_items.new('text.start_find', 'F', 'PRESS', ctrl=True, alt=True, shift=True)
kmi = km.keymap_items.new('text.jump', 'J', 'PRESS', ctrl=True)
kmi = km.keymap_items.new('text.find', 'S', 'PRESS', ctrl=True)
kmi = km.keymap_items.new('text.replace', 'R', 'PRESS', ctrl=True)
kmi = km.keymap_items.new('text.properties', 'T', 'PRESS', ctrl=True)
kmi = km.keymap_items.new('wm.editor_switch_buffer', 'X', 'PRESS', alt=True)
kmi = km.keymap_items.new('text.script_console_output', 'P', 'PRESS', alt=True, shift=True)
...
kmi_props_setattr(kmi.properties, 'data_path', 'tool_settings.use_snap')
kmi = km.keymap_items.new('wm.context_toggle', 'BUTTON4MOUSE', 'PRESS')
kmi_props_setattr(kmi.properties, 'data_path', 'tool_settings.use_uv_select_sync')
...
kmi = km.keymap_items.new('file.parent', 'P', 'PRESS', ctrl=True)
...
kmi = km.keymap_items.new('outliner.selectability_toggle', 'I', 'PRESS')
...
kmi = km.keymap_items.new('anim.keyframe_insert', 'S', 'PRESS')
kmi = km.keymap_items.new('anim.keyframe_delete', 'S', 'PRESS', alt=True)
...
# the following two bindings bind operators which no longer exist. what was their purpose? fix
...
kmi = km.keymap_items.new('graph.keyframe_insert', 'S', 'PRESS')
...
kmi = km.keymap_items.new('action.keyframe_insert', 'S', 'PRESS')
...
kmi_props_setattr(kmi.properties, 'deselect', True)
kmi = km.keymap_items.new('mask.select_border', 'EVT_TWEAK_S', 'ANY')
kmi_props_setattr(kmi.properties, 'extend', False)
kmi = km.keymap_items.new('mask.select_border', 'EVT_TWEAK_S', 'ANY', any=True)
kmi = km.keymap_items.new('mask.select_lasso', 'EVT_TWEAK_M', 'ANY')
kmi_props_setattr(kmi.properties, 'extend', False)
kmi = km.keymap_items.new('mask.select_lasso', 'EVT_TWEAK_M', 'ANY', ctrl=True)
kmi_props_setattr(kmi.properties, 'deselect', True)
kmi = km.keymap_items.new('mask.select_lasso', 'EVT_TWEAK_M', 'ANY', any=True)
kmi = km.keymap_items.new('mask.select_circle', 'Q', 'PRESS', shift=True)
...
kmi = km.keymap_items.new('mask.hide_view_clear', 'H', 'PRESS', shift=True, ctrl=True)
kmi = km.keymap_items.new('mask.hide_view_set', 'H', 'PRESS')
kmi_props_setattr(kmi.properties, 'unselected', False)
kmi = km.keymap_items.new('mask.hide_view_set', 'H', 'PRESS', alt=True)
kmi_props_setattr(kmi.properties, 'unselected', True)
...
kmi = km.keymap_items.new('mask.shape_key_insert', 'S', 'PRESS')
kmi = km.keymap_items.new('mask.shape_key_clear', 'S', 'PRESS', alt=True)
